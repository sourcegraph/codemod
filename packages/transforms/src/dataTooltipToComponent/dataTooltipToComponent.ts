...
/**
 * Convert `<div data-tooltip="example" />` element to the `<Tooltip content="example"><div /></Tooltip>` components.
 */
export const dataTooltipToComponent = runTransform(context => {
